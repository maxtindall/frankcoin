...
- **Cap:** 100,000,000 FRANK (9 decimals). Enforced on-chain; unexceedable.
- **Issuance:** fully mined from zero. No pre-mint, no founder allocation, no
  ...
  mint by signing.
- **Reward:** 50 FRANK per accepted proof at genesis, halving each supply
  tranche (50M → 25M → 12.5M …). The series sums to the cap; integer dust near
...
proofs rejected, reward = 50 FRANK/proof at genesis.
